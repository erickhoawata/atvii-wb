...
export default class Servicos extends Component<props> {
    ...
    render() {
        let estiloBotao = `btn waves-effect  purple accent-2 button ${this.props.tema}`
        ...
        <h2 className="nomeServ">Serviço</h2>
            ...
            <div className="row">
                <div className="col s12 center">
                    ...
                    <button className="btn waves-effect purple accent-2 button botaoAtualiza" type="submit" name="action">Atualizar</button>
                    </Link>
                    <button className="btn waves-effect purple accent-2 button" type="submit" name="action">Deletar Serviço</button>
                </div>
            </div>
