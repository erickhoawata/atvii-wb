...
export default class AppRoutes extends Component <{}, state>{
    ...
    render(){
        ...
        return(
            <Routes>
                <Route path="/" element={<Cadastros tema="purple accent-2"/>}/>
                <Route path="/Home" element={<Cadastros tema="purple accent-2"/>}/>
                <Route path="/Produtos" element={<ListaProduto tema="purple accent-2"/>}/>
                <Route path="/Servicos" element={<ListaServicos tema="purple accent-2"/>}/>
                <Route path="/Clientes" element={<ListaCliente tema="purple accent-2"/>}/>
                <Route path="/Pedidos" element={<ListaPedido tema="purple accent-2"/>}/>
                <Route path="/CadastroCliente" element={<FormularioCadastroCliente tema="purple accent-2"/>}/>
                <Route path="/CadastroProduto" element={<CadastroProdutos tema="purple accent-2"/>}/>
                <Route path="/CadastroServico" element={<CadastroServicos tema="purple accent-2"/>}/>
                <Route path="/CadastroPedido" element={<RealizarPedido tema="purple accent-2"/>}/>
                <Route path="/Cliente" element={<Cliente tema="purple accent-2"/>}/>
                <Route path="/Produto" element={<Produto tema="purple accent-2"/>}/>
                <Route path="/Servico" element={<Servicos tema="purple accent-2"/>}/>
