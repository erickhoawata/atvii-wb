...
export default class Roteador extends Component<{}, state> {
    ...
    render() {
        let barraNavegacao = <BarraNavegacao tema="purple accent-2" botoes={['Home', 'Clientes', 'Produtos', 'Serviços']} />
        ...
        if (this.state.tela === 'Home'){
            return (
                <>
                    {barraNavegacao}
                    <Cadastros tema="purple accent-2" />
                </>
            )
        }
        ...
        if (this.state.tela === 'Clientes') {
            return (
                <>
                    {barraNavegacao}
                    <ListaCliente tema="purple accent-2" />
                </>
            )
        }
        ...
        if (this.state.tela === 'Produtos'){
            return(
                <>
                {barraNavegacao}
                <ListaProduto tema="purple accent-2" />
                </>
            )
        }
        ...
        if (this.state.tela === 'Servicos'){
            return(
                <>
                {barraNavegacao}
                <ListaServicos tema="purple accent-2" />
                </>
            )
        }
